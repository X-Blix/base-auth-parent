...
import com.example.liuy.log.mapper.SysOperLogMapper;
import com.example.liuy.log.service.SysOperLogService;
...
<SysOperLogMapper, SysOperLog> implements SysOperLogService {
    ...
    public IPage<SysOperLog> selectPage(Page<SysOperLog> pageParam, SysOperLogQueryVo sysOperLogQueryVo) {
        ...
        return sysOperLogMapper.selectPage(pageParam,sysOperLogQueryVo,null);
    }
