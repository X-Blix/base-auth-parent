...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setDbType(DbType.MYSQL) // 设置数据库类型
                .setUrl("jdbc:mysql://localhost:3306/base-kc?useSSL=false&serverTimezone=UTC") // 数据库连接URL
        ...
        strategyConfig.setInclude("sys_user") // 指定需要生成代码的表名
        ...
        packageConfig.setParent("com.example.aaa") // 设置父包名
